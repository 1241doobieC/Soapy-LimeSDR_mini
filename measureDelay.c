...
#define FREQUENCY 1e9 //Hz
#define CLOCK_RATE 100e6 //Hz
#define SAMPLE_RATE_TX 25e6 //Hz
#define SAMPLE_RATE_RX 25e6 //Hz
...
#define CONTIGUOUS_BUFF_TX_LENGTH (int) 1e6
#define CONTIGUOUS_BUFF_RX_LENGTH (int) 1e6
...
void MixSignals(complex float* contBufferTx, complex float* contBufferRx, complex float* mixedSignal);
